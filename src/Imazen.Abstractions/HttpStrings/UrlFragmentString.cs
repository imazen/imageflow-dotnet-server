...
namespace Imazen.Abstractions.Urls;
...
public readonly struct UrlFragmentString : IEquatable<UrlFragmentString>
{
    /// <summary>
    /// Represents the empty fragment string. This field is read-only.
    /// </summary>
    public static readonly UrlFragmentString Empty = new UrlFragmentString(string.Empty);
    ...
    public UrlFragmentString(string value)
    {
    ...
    public static UrlFragmentString FromUriComponent(string uriComponent)
    {
        if (String.IsNullOrEmpty(uriComponent))
        {
            return Empty;
        }
        return new UrlFragmentString(uriComponent);
    }
    ...
    /// <returns>The resulting FragmentString</returns>
    public static UrlFragmentString FromUriComponent(Uri uri)
    {
        ...
        return new UrlFragmentString(fragmentValue);
    }

    /// <summary>
    /// Evaluates if the current fragment is equal to another fragment <paramref name="other"/>.
    /// </summary>
    /// <param name="other">A <see cref="UrlFragmentString" /> to compare.</param>
    /// <returns><see langword="true" /> if the fragments are equal.</returns>
    public bool Equals(UrlFragmentString other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj is UrlFragmentString && Equals((UrlFragmentString)obj);
    }
    ...
    /// </summary>
    /// <param name="left">A <see cref="UrlFragmentString"/> instance.</param>
    /// <param name="right">A <see cref="UrlFragmentString"/> instance.</param>
    /// <returns><see langword="true" /> if the fragments are equal.</returns>
    public static bool operator ==(UrlFragmentString left, UrlFragmentString right)
    {
