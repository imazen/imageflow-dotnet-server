...
// Polyfill of a polyfill
// Copied from https://github.com/dotnet/runtime/tree/21b4a8585362c1bc12d545b63e62a0d9dd4e8673/src/libraries/System.Text.Encodings.Web/src/Polyfills
...
namespace Imazen.Abstractions.HttpStrings
{
    internal readonly struct Rune : IEquatable<Rune>
    {
        ...
        {
            // x UnicodeDebug.AssertIsValidScalar(scalarValue);
            _value = scalarValue;
        }
        ...
        NotAscii:
            ...
            // x UnicodeDebug.AssertIsValidSupplementaryPlaneScalar(tempValue);
