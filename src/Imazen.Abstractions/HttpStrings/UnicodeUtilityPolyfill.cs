...
namespace Imazen.Abstractions.HttpStrings
{
    internal static class UnicodeUtility
    {
        ...
        {
            // x UnicodeDebug.AssertIsValidCodePoint(codePoint);
        ...
        {
            // x UnicodeDebug.AssertIsHighSurrogateCodePoint(highSurrogateCodePoint);
            // x UnicodeDebug.AssertIsLowSurrogateCodePoint(lowSurrogateCodePoint);
        ...
        {
            // x UnicodeDebug.AssertIsValidScalar(value);
        ...
        {
            // x UnicodeDebug.AssertIsValidSupplementaryPlaneScalar(value);
