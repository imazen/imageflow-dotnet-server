...
namespace Imazen.DiskCache {
    internal class CleanupWorker : IssueSink, IDisposable {
        ...
        /// </summary>
        private long lastFoundItemsOverMax = DateTime.MinValue.Ticks;

        /// <summary>
        /// The last time a cache query came through
        /// </summary>
        private long lastBusy = DateTime.MinValue.Ticks;
        /// <summary>
        ...
        /// </summary>
        private long lastWorked = DateTime.MinValue.Ticks;
        ...
        private void RemoveFile(CleanupWorkItem item) {
            ...
            cache.Locks.TryExecuteSynchronous(item.RelativePath.ToUpperInvariant(), 10, delegate() {
        ...
        public void FlushAccessedDate(CleanupWorkItem item) {
            ...
            try{
                cache.Locks.TryExecuteSynchronous(item.RelativePath.ToUpperInvariant(), 1, delegate ()
                {
